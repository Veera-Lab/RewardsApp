...
public class RewardsControllerTest {
	...
	private static void setUpData() {
		...
		Transaction trans1 = Transaction.builder().setPrice(60).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();
		Transaction trans2 = Transaction.builder().setPrice(110).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();

		cal.add(Calendar.DAY_OF_MONTH, -35);
		Transaction trans3 = Transaction.builder().setPrice(120).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();
		Transaction trans4 = Transaction.builder().setPrice(1300).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();

		cal.add(Calendar.DAY_OF_MONTH, -32);
		Transaction trans5 = Transaction.builder().setPrice(80).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();
		Transaction trans6 = Transaction.builder().setPrice(900).setCustomerId(100).setTransactionDate(cal.getTime())
				.build();
